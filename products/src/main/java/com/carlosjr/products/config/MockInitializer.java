...
public class MockInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Product product1 = new Product(1L,1L, "Hamburguer", 1.25, ProductType.ALIMENTOS, FeedSubProduct.CAFE_PETISCOS, UnitType.UNIDADE, "Komprão", now, true);
        Product product2 = new Product(2L, 2L, "Maça", 5.25, ProductType.ALIMENTOS, FeedSubProduct.FRUTAS_LEGUMES, UnitType.KG, "Komprão", now, true);
        Product product3 = new Product(3L, 1L,  "Leite", 4.25, ProductType.ALIMENTOS, FeedSubProduct.CAFE_PETISCOS, UnitType.LITRO, "Komprão", now, true);
